package click.ahimmoyak.companyservice.auth.jwt;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        String accessToken = jwtTokenProvider.getTokenFromHeader(request, JwtTokenProvider.ACCESS_TOKEN);
        String refreshToken = jwtTokenProvider.getTokenFromHeader(request, JwtTokenProvider.REFRESH_TOKEN);
