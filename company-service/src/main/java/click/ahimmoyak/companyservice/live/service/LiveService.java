...
import click.ahimmoyak.companyservice.live.dto.LiveCourseResponseDTO;
import click.ahimmoyak.companyservice.live.dto.LiveCreateRequestDTO;
import click.ahimmoyak.companyservice.live.dto.LiveTutorResponseDTO;
...
//        }
    ...
    public void endLive(String streamKey) {
        ...
        chatService.saveAttendHistory(liveId);
        liveQuizService.saveDataToDb(liveId);
